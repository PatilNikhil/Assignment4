...
Server.prototype.start = function() {
	...
	console.log("[httpServer.js]  >> [start]  >> init");
	...
	//function to create server
	 http.createServer(function(request, response) {
		...
		console.log("[httpServer.js]  >> [start]  >> Method : " + request.method);
		console.log("[httpServer.js]  >> [start]  >> Header type :" + request.headers.accept);
		...
		console.log("[httpServer.js]  >> [start]  >> Path : " + path);
		console.log("[httpServer.js]  >> [start]  >> q : " + string);	
